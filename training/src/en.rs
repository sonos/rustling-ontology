...
pub fn examples_time(v: &mut Vec<::rustling::train::Example<Dimension>>) {
    ...
    example!(v, check_moment!(c, [2015, 3, 3]), "march 3 2015", "march 3rd 2015", "march third 2015", "3/3/2015", "3/3/15", "2015-3-3", "2015-03-03");
    ...
    example!(v, check_moment!(c, [2013, 2, 12, 15]), "3ish pm", "3pm approximately", "at about 3pm");
    ...
    example!(v, check_moment!(c, [2013, 2, 13, 4]), "in a day", "a day from now");
    example!(v, check_moment!(c, [2016, 2]), "3 years from today");
    example!(v, check_moment!(c, [2013, 2, 19, 4]), "in 7 days");
    example!(v, check_moment!(c, [2013, 2, 19]), "in 1 week", "in a week");
    example!(v, check_moment!(c, [2013, 2, 5, 4]), "7 days ago");
    example!(v, check_moment!(c, [2013, 1, 29, 4]), "14 days ago", "a fortnight ago");
    ...
    example!(v, check_moment!(c, [2013, 2, 19, 4]), "7 days hence");
    example!(v, check_moment!(c, [2013, 2, 26, 4]), "14 days hence", "a fortnight hence");
